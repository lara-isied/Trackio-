...
public final class GroupItemBinding implements ViewBinding {
  ...
  private GroupItemBinding(@NonNull LinearLayout rootView, @NonNull TextView tripNumber) {
  ...
  public static GroupItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.trip_number;
      TextView tripNumber = ViewBindings.findChildViewById(rootView, id);
      if (tripNumber == null) {
        break missingId;
      }

      return new GroupItemBinding((LinearLayout) rootView, tripNumber);
    }
